...
class PieChartView: UIView {
  ...
  // MARK: - React
  // overrides parent class didSetProps method in order to re-draw piechart upon prop update
  ...
  // props must be member variables of the class, exposed to Obj-C using the @objc annotation
