...
function shuffleBoard(puzzle) {
  let previous = null;
  // keep track of previous so we don't keep moving same square back and forth
  // suppose center square is empty in 3x3. At first, prev=null
  // so we can move (r,c): (1,2), (2,1) or (2, 3). If we move
